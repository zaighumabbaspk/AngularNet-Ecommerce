...
namespace eCommerce.infrastructure.Services
{
    public class EmailService : IEmailService
    {
        ...
        {
            var subject = "Verify Your Email - LuxeLiving";
            ...
            var body = $@"
                ...
                <body>
                    <div class='container'>
                        ...
                        <div class='content'>
                            <p>Hello,</p>
                            <p>Thank you for creating an account with LuxeLiving!</p>
                            ...
                            <p>If you didn't create an account with LuxeLiving, please ignore this email.</p>
                            <p>Best regards,<br>The LuxeLiving Team</p>
                        </div>
                        <div class='footer'>
                            <p>© 2026 LuxeLiving. All rights reserved.</p>
