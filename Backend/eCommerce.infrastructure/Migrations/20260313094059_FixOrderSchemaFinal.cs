...
{
    /// <inheritdoc />
    public partial class FixOrderSchemaFinal : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Add new required columns to Orders table
            ...
            // Rename OrderStatusHistory table to OrderStatusHistories if it exists
            migrationBuilder.Sql(@"
                IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'OrderStatusHistory')
                BEGIN
                    EXEC sp_rename 'OrderStatusHistory', 'OrderStatusHistories';
                END");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'OrderStatusHistories')
                BEGIN
                    EXEC sp_rename 'OrderStatusHistories', 'OrderStatusHistory';
                END");
        }
    }
}
